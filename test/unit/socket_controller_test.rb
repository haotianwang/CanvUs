...
class SocketTest < ActiveSupport::TestCase
  ...
  # test the socket controller method get_action_handler
  def testGetActionHandler
  ...
  # test the socket controller method get_bitmap
  def testGetBitmap
    testSocket = SocketController.new
  ...
  def testSendInitImg
    ...
    assert_equal(initImgInfo['bitmap'], newestBitmap.bitmap, "bitmap sent is not the most recent bitmap")
